...
$project_name = trim($_POST["MyPortfolio"]);
$admin_email  = trim($_POST["alexeystrigal@gmail.com"]);
$email_from  = trim($_POST["info@myportfolio.ru"]);
...
$form_subject = 'Заявка с сайта MyPortfolio';
